...
<head>
    ...
    <title>Final Project | Web Technology</title>
    <!-- Favicon-->
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{route('Index')}}">Final Project</a>
            </div>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Администратор</div>
                    <div class="email">admin@iitu.kz</div>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="@yield('active_manager')">
                        <a href="{{route('Managers')}}">
                            <i class="material-icons">view_list</i>
                            <span>Менеджеры</span>
                        </a>
                    </li>
                    <li class="@yield('active_employee')">
                        <a href="{{route('Employees')}}">
                            <i class="material-icons">view_list</i>
                            <span>Работники</span>
                        </a>
                    </li>
                    <li class="@yield('active_dep')">
